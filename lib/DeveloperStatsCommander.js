...
//                console.log (repo); return;
    ...
    DeveloperStatsCommander.prototype.digest = function (resolves) {
        ...
        console.log (this.snitch (digestedRepoStats));
        console.log (this.snitch (digestedContributorStats));
//
//        console.log (digestedContributorStats);
//        console.log (digestedRepoStats);
        return;
    }

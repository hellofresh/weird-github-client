module.exports = (function() {
    ...
    Commander.prototype.init = function() {
        ...
        var GithubWrapper = require('./Wrappers/GithubWrapper');
    ...
    Commander.prototype.askForBranch = function(branches, message, property) {
        return this.askForObject (branches, message ? message : 'Pick a branch', 'name', property);
    };

    Commander.prototype.createRepo = function(organization, name, teamId) {
        return this.githubWrapper.createFromOrg(organization, name, teamId);
    };

    Commander.prototype.addCollaborator = function(organization, name, collaborator) {
        return this.githubWrapper.addCollaborator(organization, name, collaborator);
    };

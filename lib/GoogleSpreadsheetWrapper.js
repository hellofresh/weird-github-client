 module.exports = (function() {
    ...
    var GoogleSpreadsheetWrapper = function(config) {
        if (typeof config.spreadsheetId == 'undefined') {
            throw {message: 'config.spreadsheetId is empty'};
        }

        this.credentials = require ('../google-drive-credentials.json');
        this.sheet = new GoogleSpreadsheet (config.spreadsheetId);
        this.sheetInfo = null;
    };

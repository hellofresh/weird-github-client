    ...
    DeveloperStatsCommander.prototype.start = function() {
        ...
        .then(function (repos) {
            ...
            repos = [
                ...
                {owner:{login: 'hellofresh'}, name: 'csi-service'},
                {owner:{login: 'hellofresh'}, name: 'data-science'},
                {owner:{login: 'hellofresh'}, name: 'data-science-scm'},
                {owner:{login: 'hellofresh'}, name: 'bi-api'},
                {owner:{login: 'hellofresh'}, name: 'bi-dimensions'},
                {owner:{login: 'hellofresh'}, name: 'bi-boxes-shipped'},
                {owner:{login: 'hellofresh'}, name: 'bi-adjust-parser'},
                {owner:{login: 'hellofresh'}, name: 'bi-airflow-dags'},
                {owner:{login: 'hellofresh'}, name: 'bi-data-engineering'},
                {owner:{login: 'hellofresh'}, name: 'bi-nps-comments-text-analysis'},
                {owner:{login: 'hellofresh'}, name: 'bi-cancellation-survey'},
                {owner:{login: 'hellofresh'}, name: 'bi-nps-scores'},
                {owner:{login: 'hellofresh'}, name: 'bi-subscription-status'},
            ];

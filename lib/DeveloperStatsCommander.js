module.exports = (function() {
    ...
    DeveloperStatsCommander.prototype.start = function() {
        ...
        .then (function (){
            digested = commander.digest (resolves, moment().subtract ('1', 'week').format ('X'));
...
//    }
    ...
    DeveloperStatsCommander.prototype.renderRepoStats = function (organization, digested) {
        ...
        result += '*Repository activity and authors over the last 3 weeks.*\n';
